...
const Payment = ({
    ...
    const handlePay = async () => {
        ...
        try {
            const resp = await onPay(paymentData);
            setPaymentStatus('succeeded');
            setPaymentResponse(resp || { transactionId: 'TXN_' + Math.random().toString(36).substr(2, 9), paidAmount: amt, paidAt: new Date().toISOString() });
            setStep(3);
        } catch (e) {
    ...
    const renderStep1 = () => (
        <>
            <div className="pay-section">
                <div className="pay-section-title">Payment Amount</div>
            ...
            <div className="pay-section">
                <div className="pay-section-title">Payment Date</div>
                <div className="pay-radio-group">
                    <label className="pay-radio-item">
            ...
            <div className="pay-section">
                ...
                <div style={{ border: '1px solid var(--border)', borderRadius: '10px', padding: '1rem', marginTop: '0.5rem' }}>
                    <div className="pay-new-method-header">New Payment Method <span>−</span></div>
            ...
            <div className="pay-section">
                <div className="pay-section-title">Billing Address</div>
    ...
    const renderStep2 = () => (
        <>
            <ul className="pay-summary-list">
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaGlobe /></div><div><div className="pay-summary-label">Account Number</div><div className="pay-summary-value">{accountId}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaMapMarkerAlt /></div><div><div className="pay-summary-label">Service Address</div><div className="pay-summary-value">{primaryAddress}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaDollarSign /></div><div><div className="pay-summary-label">Bill Amount</div><div className="pay-summary-value">${baseAmt.toFixed(2)}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaDollarSign /></div><div><div className="pay-summary-label">Transaction Fees</div><div className="pay-summary-value">${TRANSACTION_FEE.toFixed(2)}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaDollarSign /></div><div><div className="pay-summary-label">Payment Amount</div><div className="pay-summary-value">${totalAmt.toFixed(2)}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaCalendarAlt /></div><div><div className="pay-summary-label">Payment Date</div><div className="pay-summary-value">{today.toLocaleDateString('en-US', { day: '2-digit', month: 'long', year: 'numeric' })}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon">{paymentMethod === 'credit_card' ? <FaCreditCard /> : <FaUniversity />}</div><div><div className="pay-summary-label">Payment Method</div><div className="pay-summary-value">{paymentMethodLabel}</div></div></li>
            </ul>
    ...
    const renderStep3 = () => (
        <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ color: 'var(--text-muted)', margin: '0 auto 2.5rem' }}>A confirmation email has been sent to your Email Address.</p>
            <ul className="pay-summary-list" style={{ maxWidth: '480px', margin: '0 auto', textAlign: 'left' }}>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaGlobe /></div><div><div className="pay-summary-label">Account Number</div><div className="pay-summary-value">{accountId}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaMapMarkerAlt /></div><div><div className="pay-summary-label">Service Address</div><div className="pay-summary-value">{primaryAddress}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaDollarSign /></div><div><div className="pay-summary-label">Bill Amount</div><div className="pay-summary-value">${baseAmt.toFixed(2)}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaDollarSign /></div><div><div className="pay-summary-label">Transaction Fees</div><div className="pay-summary-value">${TRANSACTION_FEE.toFixed(2)}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaDollarSign /></div><div><div className="pay-summary-label">Payment Amount</div><div className="pay-summary-value">${paymentResponse?.paidAmount?.toFixed(2) ?? totalAmt.toFixed(2)}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaCalendarAlt /></div><div><div className="pay-summary-label">Transaction Date</div><div className="pay-summary-value">{paymentResponse?.paidAt ? new Date(paymentResponse.paidAt).toLocaleDateString('en-US', { month: 'long', day: '2-digit', year: 'numeric' }) : today.toLocaleDateString('en-US', { month: 'long', day: '2-digit', year: 'numeric' })}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon"><FaReceipt /></div><div><div className="pay-summary-label">Transaction ID</div><div className="pay-summary-value">{paymentResponse?.transactionId ?? 'N/A'}</div></div></li>
                <li className="pay-summary-row"><div className="pay-summary-icon">{paymentMethod === 'credit_card' ? <FaCreditCard /> : <FaUniversity />}</div><div><div className="pay-summary-label">Payment Method</div><div className="pay-summary-value">{paymentMethodLabel}</div></div></li>
            </ul>
            <div className="pay-btn-row">
    ...
    return (
        <div className="payment-container payment-module-wrapper">
            <div className="card" style={{ padding: '2rem', backgroundColor: '#fff', borderRadius: '12px', border: '1px solid #e0e0e0', color: '#1d1d1f', fontFamily: 'system-ui, -apple-system, sans-serif', width: '100%', maxWidth: '680px', margin: '0 auto' }}>
